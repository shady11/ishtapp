...
class VacancyController extends Controller
{
    ...
    {
        $title = 'Вакансии';
        return view('admin.vacancies.index', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.vacancies.create', compact('vacancy', 'title', 'companies', 'regions', 'busynesses', 'vacancy_types', 'job_types', 'schedules'));
    }
    ...
    public function edit(Vacancy $vacancy)
    {
        ...
        return view('admin.vacancies.edit', compact('vacancy', 'title', 'companies', 'regions', 'busynesses', 'vacancy_types', 'job_types', 'schedules'));
    }
