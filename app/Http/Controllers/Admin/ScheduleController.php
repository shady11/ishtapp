...
class ScheduleController extends Controller
{
    public function index()
    {
        ...
        return view('admin.schedules.index', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.schedules.create', compact('schedule', 'title'));
    }
    ...
    {
        $title = 'Графики работы';
        return view('admin.schedules.edit', compact('schedule', 'title'));
    }
    ...
    public function api(Request $request){
        ...
        $resultPaginated = Schedule::orderBy('name', 'asc')->orderBy('name_ru', 'asc');
        ...
        foreach ($resultPaginated as $key => $row) {
            ...
            $row->actions = '
                <a href="'.route('schedules.edit', $row).'" class="btn btn-sm btn-clean btn-icon mr-2" title="Редактировать">
                ...
                <a href="'.route('schedules.delete', $row).'" class="btn btn-sm btn-clean btn-icon" title="Удалить">
                    <span class="svg-icon svg-icon-md">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
