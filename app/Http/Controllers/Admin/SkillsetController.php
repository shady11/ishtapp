...
class SkillsetController extends Controller
{
    ...
    {
        $title = 'Умение (skillset)';
        $data = Skillset::all();
        return view('admin.skillset.index', compact('title', 'data'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.skillset.create', compact('skillset', 'title'));
    }
    ...
    {
        $title = 'Умение (skillset)';
        return view('admin.skillset.edit', compact('skillset', 'title'));
    }
    ...
    public function api(Request $request)
    {
        ...
        foreach ($resultPaginated as $key => $row) {
            ...
            $row->actions = '
                <a href="' . route('skillset.edit', $row) . '" class="btn btn-sm btn-clean btn-icon mr-2" title="Редактировать">
                ...
                <a href="' . route('skillset.delete', $row) . '" class="btn btn-sm btn-clean btn-icon" title="Удалить">
                    <span class="svg-icon svg-icon-md">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
