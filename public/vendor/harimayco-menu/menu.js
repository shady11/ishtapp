...
function addcustommenu() {
  ...
  $.ajax({
    data: {
      labelmenu : $("#custom-menu-item-name-ky").val(),
			labelmenuru : $("#custom-menu-item-name-ru").val(),
			labelmenuen : $("#custom-menu-item-name-en").val(),
...
function updateitem(id = 0) {
  if (id) {
    ...
    var labelRu = $("#idlabelmenuru_" + id).val()
		var labelEn = $("#idlabelmenuen_" + id).val()
    ...
    $('.menu-item-settings').each(function(k, v) {
      ...
      var label = $(this)
        ...
        .val();
      var labelRu = $(this).find(".edit-menu-item-title-ru").val();
			var labelEn = $(this).find(".edit-menu-item-title-en").val();
      var clases = $(this)
