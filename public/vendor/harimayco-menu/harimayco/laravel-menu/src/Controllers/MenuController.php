...
class MenuController extends Controller
{
    ...
    public function updateitem()
    {
        ...
        if (is_array($arraydata)) {
            foreach ($arraydata as $value) {
                ...
                $menuitem->labelRu = $value['labelRu'];
                $menuitem->labelEn = $value['labelEn'];
                $menuitem->labelTr = $value['labelTr'];
            ...
            $menuitem->labelRu = request()->input("labelRu");
            $menuitem->labelEn = request()->input("labelEn");
            $menuitem->labelTr = request()->input("labelTr");
    ...
    public function addcustommenu()
    {
        ...
        $menuitem->labelRu = request()->input("labelmenuru");
        $menuitem->labelEn = request()->input("labelmenuen");
        $menuitem->labelTr = request()->input("labelmenutr");
