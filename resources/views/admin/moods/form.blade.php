    ...
    <div class="m-form__actions m-form__actions--solid">
        ...
        <script>
            ...
            window.onload = function () {
                ...
                @if($mood->id)
                    document.getElementById('selected-icon').childNodes[0].src = "{{asset("storage/img/admin/emoji_icons/png_512/".$mood->img_name)}}";
                    document.getElementById('selected-text').value = "{{ $mood->img_name }}";
