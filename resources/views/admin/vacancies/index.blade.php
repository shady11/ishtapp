...
@section('content')
    ...
    @subheader
    <h2 class="text-dark font-weight-bold my-1 mr-5">Вакансия</h2>
    @endsubheader
...
<!--                <div class="dropdown dropdown-inline mr-2">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{route('vacancies.create')}}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
