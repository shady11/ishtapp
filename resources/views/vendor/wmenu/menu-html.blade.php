														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p id="menu-item-name-wrap">
																	<label class="howto" for="custom-menu-item-name-ky"> <span>Кыргызча</span>&nbsp;
																		<input id="custom-menu-item-name-ky" name="label" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Аталышы">
																	</label>
																	<label class="howto" for="custom-menu-item-name-ru"> <span>Русский</span>&nbsp;
																		<input id="custom-menu-item-name-ru" name="labelRu" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Название">
																	</label>
																	<label class="howto" for="custom-menu-item-name-en"> <span>English</span>&nbsp;
																		<input id="custom-menu-item-name-en" name="labelEn" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Name">
																	</label>
																</p>
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}" class="howto"> Кыргызча
																			<br>
																			<input type="text" id="idlabelmenu_{{$m->id}}" class="width widefat edit-menu-item-title" name="idlabelmenu_{{$m->id}}" value="{{$m->label}}">
																		</label>
																	</p>
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}" class="howto"> Русский
																			<br>
																			<input type="text" id="idlabelmenuru_{{$m->id}}" class="width widefat edit-menu-item-title-ru" name="idlabelmenuru_{{$m->id}}" value="{{$m->labelRu}}">
																		</label>
																	</p>
																	<p class="description description-thin">
																		<label for="edit-menu-item-title-{{$m->id}}" class="howto"> English
																			<br>
																			<input type="text" id="idlabelmenuen_{{$m->id}}" class="width widefat edit-menu-item-title-en" name="idlabelmenuen_{{$m->id}}" value="{{$m->labelEn}}">
																		</label>
																	</p>
