...
<div class="form-group row">
    ...
    <div class="col-6">
        ...
        <div class="fileinput @if($page->getMedia('page_thumb')->last()) fileinput-exists @else fileinput-new @endif" data-provides="fileinput">
            ...
            <div class="fileinput-preview fileinput-exists thumbnail" style="width: 320px; height: 180px;">
                    @if($page->getMedia('page_thumb')->last())
                    <img src="{{asset($page->getMedia('page_thumb')->last()->getUrl('page_middle'))}}" >
                @endif
            </div>
            <div>
...
<div class="form-group row">
    ...
    <div class="col-6">
        {!! Form::text('slug', null, ['class' => 'form-control  m-input', 'placeholder'=> '#']) !!}
    </div>
</div> 
<div class="form-group row">
    <label class="col-2 col-form-label">
