                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-widget13">                                                       
                        ...
                        <div class="m-widget13__item">
                            ...
                            <span class="m-widget13__text text-dark m--font-bolder">
                                <div class="row align-items-center">
                                    @foreach ($row->getMedia('topic_gallery') as $media)
                                    <div class="col-md-3 mb-4">
                                        <img class="img-fluid rounded" src="{{asset($media->getUrl('topic_gallery_thumb'))}}" />
                                    </div>
                                    @endforeach
                                </div>
                            </span>
                        ...
                        <div class="m-widget13__action m--align-right">
                            <a href="{{route('topics.index')}}" class="m-widget__detalis btn btn-secondary">
                                Назад
                            </a>
                            <a href="{{route('topics.edit', $row)}}" class="m-widget__detalis btn btn-info">
                                Редактировать
                            </a>
                            <a href="{{route('topics.destroy', $row)}}" class="btn btn-danger">
                                Удалить
                            </a>
                        </div>
                    </div>
