...
<div class="form-group row">
    ...
    <div class="col-6">
        ...
        <div class="fileinput @if($row->getMedia('resource_thumb')->last()) fileinput-exists @else fileinput-new @endif" data-provides="fileinput">
            ...
            <div class="fileinput-preview fileinput-exists thumbnail" style="width: 320px; height: 180px;">
                    @if($row->getMedia('resource_thumb')->last())
                    <img src="{{asset($row->getMedia('resource_thumb')->last()->getUrl('resource_middle'))}}" >
                @endif
            </div>
            <div>
...
<div class="form-group row">
    ...
    <div class="col-6">
        {!! Form::text('icon', null, ['class' => 'form-control  m-input', 'placeholder'=> '#']) !!}
    </div>
</div>
<div class="form-group row">
    <label class="col-2 col-form-label">
